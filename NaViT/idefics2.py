...
from transformers.models.idefics2.configuration_idefics2 import Idefics2Config, Idefics2PerceiverConfig, Idefics2VisionConfig
...
class Idefics2Model(Idefics2PreTrainedModel):
    ...
    def forward(
        ...
        if pixel_values is not None and image_hidden_states is not None:
            ...
            print('input image size', pixel_values.shape)
            print('ViT output size', image_hidden_states.shape)

            # Modality projection & resampling
            image_hidden_states = self.connector(
                image_hidden_states, attention_mask=patch_attention_mask.view(pixel_values.size(0), -1)
            )
            print('Resampler output size', image_hidden_states.shape)
