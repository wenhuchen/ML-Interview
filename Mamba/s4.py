...
class S4:
    ...
    def _discretize(self):
        """
        Discretize the continuous-time HiPPO matrix using zero-order hold
        (ZOH). Returns the discrete-time state matrix Ad.
    ...
    def _discretize_B(self):
        ...
        Bd = linalg.solve(self.A, (self.Ad - identity) @ self.B)
        return Bd
    ...
    def forward(self, u, x0=None):
        ...
        Args:
            ...
            x0: Initial state of shape (batch_size, N). If None, starts
                from zero.
        Returns:
